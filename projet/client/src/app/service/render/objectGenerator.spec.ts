...
describe("object Generator", () => {
    ...
    const callBack: Function = (obj: Object3DWrapper): void => { expect(obj.getPosition()).toEqual( defaultPosition); };
    ...
    it("should be able to create a cube with the position passed in param", () => {
        ObjectGenerator.Cube(callBack, defaultPosition, defaultPosition, material, 1);
    });

    it("should be able to create a Sphere with the position passed in param", () => {
        ObjectGenerator.Sphere(callBack, defaultPosition, defaultPosition, material, 1);
    });

    it("should be able to create a Tetrahedron with the position passed in param", () => {
        ObjectGenerator.Tetrahedron(callBack, defaultPosition, defaultPosition, material, 1);
    });

    it("should be able to create a Cylinder with the position passed in param", () => {
        ObjectGenerator.Cylinder(callBack, defaultPosition, defaultPosition, material, 1);
    });
});
